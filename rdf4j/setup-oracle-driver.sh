...
cp /tmp/create-oracle.xsl /opt/tomcat/webapps/rdf4j-workbench/transformations/create-oracle.xsl
cp /tmp/create.xsl        /opt/tomcat/webapps/rdf4j-workbench/transformations/create.xsl
# Should update <<username>>, <<pwd>> and <<host:port/servicename>> in context.xml
cp /tmp/context.xml       /opt/tomcat/conf/context.xml
